...
This is the prerequisite and installation of the open-source help desk ticketing system osTicket.<br />
...
1.) The first thing you will want to do is create a virtual machine by going to https://portal.azure.com/. Set up your virtual machine with Windows 10 Pro, version 22H2. Just so you know, you will want to create a virtual machine with at least 2 vcpus and 16 GB of memory.
...
<p>
<imgfor  src="https://imgur.com/F4H3ppM.png" height="40%" width="40%" alt="Disk Sanitization Steps"/>
</p>
<p>
